...
#[derive(Debug)]
pub struct LearnHubProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LearnHubProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LearnHub processing");
    
    let mut processor = LearnHubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LearnHubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LearnHubProcessor::new(false);
